...
# Registered by the 2026-09-19 volumetric campaign's flat backfill; tier 1 = loose
# pass on the table, tier 2 = platform profile only (docs/EXPLORATION-3D-20260919.md).
BACKFILL_TIERS: dict[str, int] = {"paperclip": 1, "hammer": 1, "pencil": 2, "magnifier": 2, "bottle": 2, "power": 2}
...
LAYERED_TIERS: dict[str, int] = {"stool": 1, "low-bench": 1, "half-cube": 1, "side-table": 1, "lounge": 1, "bench": 2}
